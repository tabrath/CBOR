...
namespace PeterO.Cbor.Tests {
  ...
  o.AsEInteger());
    ...
    public void TestByteStringStreamNoIndefiniteWithinDefinite() {
      Assert.Throws<CBORException>(() =>
        CBORTestCommon.FromBytesTestAB(new byte[] { 0x5f, 0x41, 0x20, 0x5f, 0x41, 0x20, 0xff, 0xff }));
    }
    [Test]
    public void TestByteStringStreamNoTagsBeforeDefinite() {
      Assert.Throws<CBORException>(() =>
        CBORTestCommon.FromBytesTestAB(new byte[] { 0x5f, 0x41, 0x20, 0xc2, 0x41, 0x20, 0xff }));
    }
  ...
  0x31, (byte)0x90, (byte)0xea, 0x16, (byte)0xbe, (byte)0x80, 0x0b, 0x37 });
    ...
    public void TestDecimalFracExponentMustNotBeBignum() {
      Assert.Throws<CBORException>(() =>
        CBORTestCommon.FromBytesTestAB(new byte[] { 0xc4, 0x82, 0xc2, 0x41, 1, 0x1a,
          1, 2, 3, 4 }));
    }
  ...
  "Inner tag doesn't match");
    ...
    public void TestTextStringStreamNoIndefiniteWithinDefinite() {
      Assert.Throws<CBORException>(() =>
        CBORTestCommon.FromBytesTestAB(new byte[] { 0x7f, 0x61, 0x20, 0x7f, 0x61, 0x20, 0xff, 0xff }));
    }
    [Test]
    public void TestTextStringStreamNoTagsBeforeDefinite() {
      Assert.Throws<CBORException>(() =>
        CBORTestCommon.FromBytesTestAB(new byte[] { 0x7f, 0x61, 0x20, 0xc0, 0x61, 0x20, 0xff }));
    }
