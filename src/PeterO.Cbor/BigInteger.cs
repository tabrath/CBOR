...
namespace PeterO {
  ...
  public sealed partial class BigInteger : IComparable<BigInteger>, IEquatable<BigInteger>
  {
...
#if CODE_ANALYSIS
    [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Security", "CA2104", Justification = "BigInteger is immutable")]
#endif
    ...
    private static readonly BigInteger ValueOneValue = new BigInteger(EInteger.One);
    ...
    internal static BigInteger ToLegacy(EInteger ei) => new BigInteger(ei);

    internal static EInteger FromLegacy(BigInteger bei) => bei.Ei;

    private static readonly BigInteger ValueZeroValue = new BigInteger(EInteger.Zero);

    internal EInteger Ei => this.ei;

    /// <include file='../docs.xml'
    /// path='docs/doc[@name="M:PeterO.BigInteger.fromBytes(System.Byte[],System.Boolean)"]/*'/>
    public static BigInteger fromBytes(byte[] bytes, bool littleEndian) => new BigInteger(EInteger.FromBytes(bytes,   littleEndian));

    /// <include file='../docs.xml'
    /// path='docs/doc[@name="M:PeterO.BigInteger.fromRadixString(System.String,System.Int32)"]/*'/>
    public static BigInteger fromRadixString(string str, int radix) =>  new BigInteger(EInteger.FromRadixString(str, radix));

    /// <include file='../docs.xml'
    /// path='docs/doc[@name="M:PeterO.BigInteger.fromString(System.String)"]/*'/>
    public static BigInteger fromString(string str) => new BigInteger(EInteger.FromString(str));

    /// <include file='../docs.xml'
    /// path='docs/doc[@name="M:PeterO.BigInteger.valueOf(System.Int64)"]/*'/>
    public static BigInteger valueOf(long longerValue) => new BigInteger(EInteger.FromInt64(longerValue));

    /// <include file='../docs.xml'
    /// path='docs/doc[@name="M:PeterO.BigInteger.bitLength"]/*'/>
    public int bitLength() => this.Ei.GetSignedBitLength();
    ...
    public override int GetHashCode() => this.Ei.GetHashCode();

    /// <include file='../docs.xml'
    /// path='docs/doc[@name="M:PeterO.BigInteger.toBytes(System.Boolean)"]/*'/>
    public byte[] toBytes(bool littleEndian) => this.Ei.ToBytes(littleEndian);

    /// <include file='../docs.xml'
    /// path='docs/doc[@name="M:PeterO.BigInteger.toRadixString(System.Int32)"]/*'/>
    public string toRadixString(int radix) => this.Ei.ToRadixString(radix);

    /// <include file='../docs.xml'
    /// path='docs/doc[@name="M:PeterO.BigInteger.ToString"]/*'/>
    public override string ToString() => this.Ei.ToString();

    /// <include file='../docs.xml'
    /// path='docs/doc[@name="M:PeterO.BigInteger.CompareTo(PeterO.BigInteger)"]/*'/>
    public int CompareTo(BigInteger other) => this.Ei.CompareTo(other == null ? null : other.Ei);
  }
}
